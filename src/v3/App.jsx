 ...
 *
 *   Hero → Content Types → Content Styles → Финальный визуал → Social → Footer
 *
 * Соцсети стоят последними, уже после «MY VISUAL WORLD» и всех связанных
 * с ним картинок: сначала посетитель смотрит работы, и только в самом
 * конце ему предлагают, где искать ещё.
 *
