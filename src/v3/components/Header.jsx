 ...
 *
 * «Let’s connect ♡» никуда не ведёт: она открывает форму связи поверх
 * сайта (components/ConnectDialog.jsx). Вторая такая же кнопка стоит
 * под соцсетями — components/ConnectInvite.jsx.
 *
