...
export default function Showcase() {
  ...
  return (
    ...
    >
      <motion.div
        variants={blurUp}
        className="relative mx-auto w-full max-w-[1560px] overflow-hidden rounded-[22px] border border-v3-ink-line/70 shadow-v3-lift"
      >
        <img
          src={src}
          alt=""
