/**
 * Дизайн-токены версии v2 — цвета, шрифты, тени, скругления.
 *
 * Файл читает tailwind.config.js и подмешивает всё отсюда в тему
 * с префиксом версии: ink → v2-ink, card → v2-card, silk → v2-silk.
 * Поэтому в разметке они выглядят так:
 *
 *   bg-v2-ink   text-v2-blush-300   rounded-v2-card   ease-v2-silk
 *
 * Смысл префикса — независимость версий. Токены v3 попадут в тему под
...
export default {
  ...
  screens: {
    /* Узкий брейкпоинт версии: v2-xs:grid-cols-3 */
    xs: '420px',
  },
}
